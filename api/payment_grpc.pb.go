...
const (
	PaymentService_StartPayment_FullMethodName = "/api.PaymentService/StartPayment"
	PaymentService_GetPayment_FullMethodName   = "/api.PaymentService/GetPayment"
)
...
type PaymentServiceClient interface {
	StartPayment(ctx context.Context, in *StartPaymentRequest, opts ...grpc.CallOption) (*StartPaymentReply, error)
...
func (c *paymentServiceClient) StartPayment(ctx context.Context, in *StartPaymentRequest, opts ...grpc.CallOption) (*StartPaymentReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StartPaymentReply)
...
func (c *paymentServiceClient) GetPayment(ctx context.Context, in *GetPaymentRequest, opts ...grpc.CallOption) (*GetPaymentReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type PaymentServiceServer interface {
	StartPayment(context.Context, *StartPaymentRequest) (*StartPaymentReply, error)
...
func (UnimplementedPaymentServiceServer) StartPayment(context.Context, *StartPaymentRequest) (*StartPaymentReply, error) {
	return nil, status.Error(codes.Unimplemented, "method StartPayment not implemented")
}
func (UnimplementedPaymentServiceServer) GetPayment(context.Context, *GetPaymentRequest) (*GetPaymentReply, error) {
